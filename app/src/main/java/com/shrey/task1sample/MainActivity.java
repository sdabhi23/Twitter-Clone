...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Tweet("Parth Modi", "@KingTargStark", "30m", "Hey there !!", R.drawable.profile_3, R.drawable.dummy_img_3, 5, 15, 100));
        list.add(new Tweet("Sudhir Phaugat", "@AmbitiousProf", "40m", "Hey there !!", R.drawable.profile_4, R.drawable.dummy_img_4, 85, 500, 1000));
        list.add(new Tweet("Bhavini Agrawal", "@MadQueen", "50m", "Hey there !!", R.drawable.profile_2, R.drawable.dummy_img_2, 75, 80, 250));
        list.add(new Tweet("Anushka Dube", "@anudube22", "1h", "Hey there !!", R.drawable.profile_1, R.drawable.dummy_img_1, 50, 100, 500));
